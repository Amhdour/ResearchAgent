    ...
    with col1:
        ...
        with col_a:
            if st.button("🤖 Open-source LLMs", use_container_width=True):
                st.session_state["query_text_input"] = "2025 trends in open-source LLMs"
                st.rerun()
        
        with col_b:
            if st.button("🧠 Agentic AI", use_container_width=True):
                st.session_state["query_text_input"] = "Latest developments in agentic AI systems"
                st.rerun()
        
        with col_c:
            if st.button("🚀 AI Applications", use_container_width=True):
                st.session_state["query_text_input"] = "Autonomous agents in real-world applications"
                st.rerun()
